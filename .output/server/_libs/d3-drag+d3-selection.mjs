...
//#endregion
//#region node_modules/react-simple-maps/node_modules/d3-drag/src/noevent.js
function noevent_default(event) {
	event.preventDefault();
	event.stopImmediatePropagation();
}
//#endregion
//#region node_modules/react-simple-maps/node_modules/d3-drag/src/nodrag.js
function nodrag_default(view) {
	var root = view.document.documentElement, selection = select_default(view).on("dragstart.drag", noevent_default, true);
	if ("onselectstart" in root) selection.on("selectstart.drag", noevent_default, true);
	else {
...
//#endregion
export { styleValue as a, namespace_default as c, selection as i, matcher_default as l, yesdrag as n, selectorAll_default as o, select_default as r, selector_default as s, nodrag_default as t };
