...
import { b as require_jsx_runtime, g as Slot } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { n as cn, t as Button } from "./button-DRsC1qZi.mjs";
import { t as Input } from "./input-DicJzR9-.mjs";
import { n as useAuth } from "./use-auth-07FyFxK7.mjs";
import { At as LayoutDashboard, Ct as LogOut, I as ShoppingBag, Kt as GraduationCap, Nt as Key, S as Ticket, V as Server, Z as RefreshCw, d as User, fn as Download, hn as Crown, lt as PanelLeft, n as Zap, o as Wallet, r as X, u as Users } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/portal-CN-_C_NG.js
...
function PortalLayout() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalSidebar, {
			primaryRole,
			initials: (profile?.full_name ?? user.email ?? "?").split(" ").map((s) => s[0]).slice(0, 2).join("").toUpperCase(),
			displayName: profile?.full_name ?? user.email?.split("@")[0] ?? "User",
			roleLabel: ROLE_LABEL[primaryRole]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex-1 flex flex-col min-w-0",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "sticky top-0 z-20 h-14 flex items-center gap-3 border-b border-border bg-background/85 backdrop-blur px-4",
				children: [
...
function PortalSidebar({ primaryRole, initials, displayName, roleLabel }) {
	const { state } = useSidebar();
	const collapsed = state === "collapsed";
	const pathname = useRouterState({ select: (r) => r.location.pathname });
	const isActive = (url) => url === "/portal" ? pathname === "/portal" : pathname === url || pathname.startsWith(url + "/");
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "h-9 w-9 shrink-0 rounded-xl bg-gradient-brand flex items-center justify-center",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Zap, {
							className: "h-4 w-4 text-white",
							strokeWidth: 2.5
						})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: "Main" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: MAIN_ITEMS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(item.icon, { className: "h-4 w-4 shrink-0" }), !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "truncate",
						children: item.title
					})]
				})
			}) }, item.url)) }) })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: "Account" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: accountItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
				asChild: true,
				isActive: isActive(item.url),
				tooltip: item.title,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: cn("flex items-center gap-2 p-2", collapsed && "justify-center"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
